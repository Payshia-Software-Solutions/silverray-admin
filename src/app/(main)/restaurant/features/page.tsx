...
import { getRestaurantFeatures, deleteRestaurantFeature, type RestaurantFeatureFromApi } from '@/lib/services/api';
...
export default function RestaurantFeaturesPage() {
