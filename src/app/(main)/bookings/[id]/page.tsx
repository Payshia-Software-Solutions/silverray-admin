...
import { getBookingById, updateBooking, getCustomers, getRoomTypes, getRooms, BookingFromApi, CustomerFromApi, RoomTypeFromApi, RoomFromApi } from '@/lib/services/api';
...
export default function EditBookingPage() {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitting }, reset, control } = useForm<BookingFormValues>({
